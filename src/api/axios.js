...
export const Session = {
    ...
    exportUrl: 'http://120.24.81.27:8800/xiangmubao/p/interface/',
    limits: JSON.parse(sessionStorage.getItem('limits')),
    browse:'http://58.246.254.194:8012/onlinePreview?url='
}

export function Axios(reqBody, thisUrl, getFileId) {
    let data = {
        "from": "android",
        "version": "1.0",
    ...
    //http://172.17.0.14:8025
    //http://172.17.0.11:8081
    //http://120.24.81.27:8800
    //http://172.17.0.8:8007
    return axios.post('http://120.24.81.27:8800/xiangmubao/p/interface/' + thisUrl + '/api', { str: JSON.stringify(data) }).then((res) => {
