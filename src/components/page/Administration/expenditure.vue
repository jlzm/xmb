<template>
  <div class="backlog">
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope" v-if="limit==1">
                <el-tooltip v-if="jurisdiction.database.save" class="item" effect="dark" content="编辑"
                            placement="top-end">
    ...
    <el-dialog title="编辑支出类别" :visible.sync="compileVisible" width="40%">
      <el-form :model="searchData" class="newStaff">
        <el-form-item :required='true' label="支出类别：" label-position="left" label-width="100px">
