<template>
    <div class="bid">
        <div class="listBox">
            ...
            <!-- 支出 -->
            <div class="contentBox clearfix bgWhite padTb10" v-if="this.$route.query.sType==0"> 
                <div class="pad20 bgWhite">
                    ...
                    <el-table
                        ...
                        width="240">
                            <template slot-scope="scope">
                                <span>{{$route.query.state==1?'采购支出':'项目支出 '}}</span>
                            </template>
                        </el-table-column>
                        <!-- <el-table-column
                        prop="totalamount"
            ...
            <!-- 收入 -->
            <div class="contentBox clearfix bgWhite padTb10"  v-if="this.$route.query.sType==1">
                <div class="pad20 bgWhite">
                    <!-- 投标文件开始 -->
                    <el-table
                        ref="multipleTable"
...
export default {
  ...
  created () {
         if(this.$route.query.sType=='1'){
             this._selectrmoneylist()
         }else{
             this._selectdetailliste()
         }
  ...
  methods:{
    ...
    _selectrmoneylist(){
        this.loading = true
        let reqBody = {
            "api": "selectrmoneylist",
            "page": this.page,
            "pagesize":this.pageSize,
            "projectid":this.$route.query.typeid,
            "companyid": sessionStorage.getItem('companyid'),
